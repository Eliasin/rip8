use crate::logic::instruction::{ Instruction, ByteOrVReg };
...
fn get_val_from_byte_or_v_register(byte_or_register: ByteOrVReg, register_file: &RegisterFile) -> u8 {
...
pub fn execute_instruction(instruction: Instruction, register_file: &mut RegisterFile, ram: &mut RAM) {
    match instruction {
